...
Also encounted 5.2.7 - The code in TST does not handle the empty string properly. Explain the problem and suggest a correction.

The problem is that the implementation assumes that each node has a single-character string in the node.character attribute, and it does not account for a 0-length empty string as a value. One solution is initializing the root node as the empty string node, and upholding the invariant that it only has a .middle property, and that .left and .right are always None. We need to be careful to uphold this invariant in the rest of the code.

Also encountered 5.2.9 - Extended operations for TSTs. Implement keys() and the extended opera- tions introduced in this section—longestPrefixOf(), keysWithPrefix(), and keysThatMatch()—for TST.
'''
...
# print(trie.keys())
# print(trie.size)
# print(trie.keysWithPrefix('z'))
# print(trie.keysThatMatch('**c'))
# print(trie.longestPrefixOf('caba'))
# trie.delete('bac')
# trie.delete('db')
# trie.delete('da')
...
# print(tst.get(''))
# print(tst.keys())
# print(tst.keysWithPrefix(''))
# print(tst.keysThatMatch('a'))
# print(tst.keysThatMatch('b'))
# print(tst.keysThatMatch('*b'))
# print(tst.longestPrefixOf('caba'))
