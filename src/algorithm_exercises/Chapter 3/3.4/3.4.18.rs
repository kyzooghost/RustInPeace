...
// 3.4.18
// Add a constructor to SeparateChainingHashST that gives the client the 
// ability to specify the average number of probes to be tolerated for searches. 
// Use array resizing to keep the average list size less than the specified value, 
// and use the technique described on page 478 to ensure that the modulus for hash() is prime.

// Average list size = num_of_keys / size
// Must resize if average list size >= threshold
