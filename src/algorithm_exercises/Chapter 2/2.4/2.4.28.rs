...
// Write a TopM client that reads points (x, y, z) from standard input, 
// takes a value M from the command line, 
// and prints the M points that are closest to the origin in Euclidean distance. 
// Estimate the running time of your client for N = 10^8 and M = 10^4

// This is trivial
// Write a MinPQ implementation for (usize, usize, usize, usize) = (distance, x, y, z)
// Heap-ordered according to 'distance'
// Call delMin() M times
