...
// where each node contains a reference to the item preceding it 
// and the item following it in the list (null if there is no such item). 
...
fn main () {
    ...
    list.insert_at_tail("z");
    list.insert_at_tail("y");
    println!("{:?}", list.remove_from_tail());
    println!("{:?}", list.remove_from_tail());
    println!("{:?}", list.remove_from_head());
    println!("{:?}", list.remove_from_head());
    ...
    list.insert_at_tail("z");
    list.insert_at_tail("y");
    println!("{:?}", list.remove_at_index(0));
    println!("{:?}", list.remove_at_index(3));
    println!("{:?}", list.remove_at_index(2));
    println!("{:?}", list.remove_from_tail());
    println!("{:?}", list.remove_from_tail());
    ...
    list.insert_at_tail("z");
    list.insert_at_tail("y");
    println!("{:?}", list.remove_at_index(1));
    println!("{:?}", list.remove_at_index(1));
    println!("{:?}", list.remove_at_index(1));
    println!("{:?}", list.remove_at_index(1));
    println!("{:?}", list.remove_at_index(0));
